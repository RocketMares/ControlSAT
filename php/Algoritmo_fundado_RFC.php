...
class AlgoritmoRFC{
        ...
        */
        ...
        $apellidoPaterno = self::QuitarArticulos($apellidoPaterno);
        $apellidoMaterno = self::QuitarArticulos($apellidoMaterno);
        ...
        self::CalcularHomoclave($apellidoPaterno." ".$apellidoMaterno." ".$nombre, $fecha,$rfc);
        return $rfc;
        }
